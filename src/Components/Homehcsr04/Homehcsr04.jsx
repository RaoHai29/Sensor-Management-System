...
function Homehcsr04(props) {
  ...
  const drawer = (
    <div>
      ...
      <Divider />
      <List>
        <Typography variant="h6" component='h6' sx={{ textAlign: 'center', fontWeight: '600', marginBottom: '30px' }}>HCSR04</Typography>
...
Homehcsr04.propTypes = {
  window: PropTypes.func,
};

export default Homehcsr04;
