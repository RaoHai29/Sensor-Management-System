...
function Speedometer() {
    ...
    return (
        <>
            <div>
                <h4>Showing temperature values of DS18B20 Sensor</h4>
                <p style={{ margin: "-1px 0" }}>Max value: {max}&deg;C</p>
                <p style={{ margin: "0px 0px 9px" }}>Min value: {min}&deg;C</p>
            </div>
            ...
            <div className="speedometer">
                <div className="center-point">
                    <span className="value">{speed.length ? (parseFloat(value)).toFixed(1) : ""}</span>
